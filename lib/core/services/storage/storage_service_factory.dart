...
class StorageServiceFactory {
  ...
  Future<bool> _shouldUseCloudStorage() async {
    ...
    final cloudSyncEnabled = _localStorageService.getSetting('cloudSyncEnabled', defaultValue: false);
  ...
  Future<void> setCloudSyncEnabled(bool enabled) async {
    await _localStorageService.setSetting('cloudSyncEnabled', enabled);
